                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    ...
                    >
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed mb-6">
                            I am a passionate <span className="text-blue-400 font-semibold">Full Stack Developer</span> specialized in the MERN stack.
                            My journey in programming is driven by curiosity and a desire to build solutions that matter.
                        </p>
